...
// Format: room_id:booking_id:access_code:timestamp
$current_time = time();
$qr_data = json_encode([
...
// Encrypt the data for security (in a real app, use proper encryption)
$encrypted_data = base64_encode($qr_data);

// Save the access code in the database (optional, for verification)
...
// QR code content - this would be scanned by the door access system
...
<body>
    ...
    <div class="checkin-container">
        ...
        <div class="timer">
            Mã QR sẽ hết hạn sau: <span id="countdown">15:00</span>
        </div>
