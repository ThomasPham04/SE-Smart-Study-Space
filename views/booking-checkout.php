...
$success = $student->checkOut($booking_id);
...
if ($success) {
    ...
    $_SESSION['success_message'] = 'Bạn đã check-out thành công khỏi phòng ' . $room_name;
} else {
    $_SESSION['error'] = 'Không tìm thấy thông tin đặt phòng hoặc bạn không có quyền check-out, hoặc có lỗi xảy ra khi check-out.';
}
